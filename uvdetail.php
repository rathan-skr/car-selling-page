...
<div class="bg_image"><h1>New record created successfully! Thank You for registraring with Us</h1>
     <h1>last entry details</h1>
  ...
  $email  = $_POST['email'];
    ...
    $sql = "SELECT * FROM `vdetails`WHERE   email= '$email'";
    //$sql = "SELECT vmodel,vtype,brand,price,vcondition,filename,email FROM vdetails WHERE email= '$email'";
